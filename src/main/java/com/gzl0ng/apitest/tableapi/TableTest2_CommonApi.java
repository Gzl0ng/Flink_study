...
public class TableTest2_CommonApi {
    public static void main(String[] args) throws Exception {
        ...
        //1.1基于老版本planner的流处理(Batch Stream设置流处理还是批处理模式)
        ...
        //1.2基于老版本的批处理(新版本流批统一，都是DataStream)
        ...
        EnvironmentSettings blinkBatchSettings = EnvironmentSettings.newInstance()
                ...
                .inBatchMode()
                .build();
        TableEnvironment blinkbatchenviromentEnv = TableEnvironment.create(blinkBatchSettings);
